            ...
            <div class="card demo-icons">
              ...
              <div class="card-body"> 
                <div class="table-responsive">
                  <?php echo form_open_multipart(base_url()."Admin/EditKelas"); ?>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama Kelas <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="nama_kelas"   class="form-control "  value="<?php echo $kelas[0]->nama_kelas;?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="angkatan"  class="form-control "  value="<?php echo $kelas[0]->angkatan;?>">
                        </div>
                      </div>                      
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <input type="hidden" id="last-name" name="id_kelas"   class="form-control "  value="<?php echo $kelas[0]->id_kelas;?>">
