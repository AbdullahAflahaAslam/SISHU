...
<link href="http://cdn.jsdelivr.net/timepicker.js/latest/timepicker.min.css" rel="stylesheet"/>
            ...
            <div class="card demo-icons">
              <div class="card-header">
                <h4 class="card-title"> Tambahkan Admin </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <?php echo form_open_multipart(base_url()."Admin/InputAdmin"); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="last-name" name="email"  class="form-control "  value="">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-12 pl-1">
                            <div class="form-group">
                              <input type="hidden" name="phoneCode"  value="62"  required="">
                              <input type="text" name="phone"  value="" size="13" class="form-control " maxlength="13" required="">      
                            </div>
                           
                          </div>
                        </div>
                         <code>*hilangkan angka 0(kosong) dari digit pertama no.hp anda</code>
                       </div> -->
                       <input type="number" name="phone"  value="" size="13" class="form-control " maxlength="13" required="">  
                        <input type="hidden" name="country"  value="Indonesia"  required="">
                        <input type="hidden" name="phoneCode"  value="62"  required="">
                      ...
                      <!-- <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Wilayah SHU <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="wilayah_shu" required="required"  class="form-control "  value="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="penanggung_jawab" required="required"  class="form-control "  value="">
                        </div>
                      </div> -->
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="last-name" name="password" required="required"  class="form-control "  value="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="last-name" name="conf_password" required="required"  class="form-control "  value="">
                        </div>
                      </div>
