                ...
                <form method="post" action="<?php echo base_url(); ?>Admin/EditAdmin">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="FName"  class="form-control "  value="<?php echo $admin[0]->FName ?>" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="MName"  class="form-control "  value="<?php echo $admin[0]->MName ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="LName"  class="form-control "  value="<?php echo $admin[0]->LName ?>">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="no_ktp"  class="form-control "   required="required" value="<?php echo $admin[0]->no_ktp ?>">
                        </div>
                      </div> -->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="" type="email" id="last-name" name="email" required="required" class="form-control " value="<?php echo $admin[0]->email?>">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="AddLine"  class="form-control " value="<?php echo $admin[0]->AddLine?>">
                        </div>
                      </div> -->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="city" required="required" class="form-control "  value="<?php echo $admin[0]->city?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="province" required="required" class="form-control "  value="<?php echo $admin[0]->province?>">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="country" required="required"  class="form-control "  value="<?php echo $admin[0]->country?>">
                        </div>
                      </div>
                       -->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="phone" required="required"  class="form-control "  value="<?php echo $admin[0]->phone?>">
                        </div>
                      </div>
                     ...
                     <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="last-name" name="poscode"    class="form-control "  value="<?php echo $admin[0]->poscode?>">
                        </div>
                      </div> -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="user" required="required"  class="form-control "  value="<?php echo $admin[0]->user?>">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="last-name" name="pass" required="required"   class="form-control "  value="<?php echo $this->encryption->decrypt($admin[0]->pass);?>">
                        </div>
                      </div> -->
                      <div class="ln_solid"></div>
                      <div class="form-group">
                      <input type="hidden" id="last-name" name="pass" required="required"   class="form-control "  value="<?php echo $this->encryption->decrypt($admin[0]->pass);?>">
                      <input type="hidden" id="last-name" name="id_user" required="required"  class="form-control "  value="<?php echo $admin[0]->id_user?>">
                      <input type="hidden" id="last-name" name="userLast" required="required"  class="form-control "  value="<?php echo $admin[0]->user?>">
                      <input type="hidden" id="last-name" name="country" required="required"  class="form-control "  value="<?php echo $admin[0]->country?>">
  ...
  <div class="modal fade" id="ResetPassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form form method="POST" action="<?php echo base_url().'Admin/ResetPassword/'.$admin[0]->id_user ?>" class="">
          <input type="hidden" id="last-name" name="id_user" required="required"  class="form-control "  value="<?php echo $admin[0]->id_user?>">
